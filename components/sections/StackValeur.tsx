...
export default function StackValeur({ tone = "ink" }: StackValeurProps) {
...
function IconRadar({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="18" stroke="#F3ECE1" strokeWidth="1.5" opacity="0.4" />
      <circle cx="24" cy="24" r="10" stroke="#F3ECE1" strokeWidth="1.5" opacity="0.6" />
...
function IconQuestion({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="18" stroke="#F3ECE1" strokeWidth="1.5" />
      <path
...
function IconReport({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <rect x="10" y="7" width="28" height="34" rx="1" stroke="#F3ECE1" strokeWidth="1.5" />
      <path
...
function IconSearch({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="21" cy="21" r="12" stroke="#F3ECE1" strokeWidth="1.5" />
...
function IconCheckout({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <rect x="8" y="14" width="32" height="22" rx="1" stroke="#F3ECE1" strokeWidth="1.5" />
      <path d="M8 21 h32" stroke="#F3ECE1" strokeWidth="1.5" />
